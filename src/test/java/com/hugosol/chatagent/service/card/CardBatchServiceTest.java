...
class CardBatchServiceTest {
    ...
    void importCards_allValid_successfullyImportsAllCards() {
        ...
        byte[] csvBytes = ("front,back,stability,difficulty,cardState,due,reps,lapses,lastReview,firstReviewDate,step\n" +
                "hello,world,3.0,0.3,Review,2024-06-01T10:00:00Z,5,2,2024-05-01T10:00:00Z,2024-06-01,-1\n" +
                "goodbye,再见,2.5,0.1,New,2024-06-02T10:00:00Z,0,0,,,-1\n").getBytes(StandardCharsets.UTF_8);
        ...
        assertThat(savedCards.get(0).getStep()).isEqualTo(-1);
        assertThat(savedCards.get(1).getStep()).isEqualTo(-1);
